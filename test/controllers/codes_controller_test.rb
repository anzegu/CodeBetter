...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { content: @code.content, language_id: @code.language_id, problem_id: @code.problem_id } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { content: @code.content, language_id: @code.language_id, problem_id: @code.problem_id } }
